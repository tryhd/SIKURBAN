...
<div id="top">
   ...
   <nav class="navbar" style="navbar;
      ...
      <div class="container-fluid m-0">
		  <a class="navbar-brand float-left text-center" href="<?=base_url()?>index.php/dashboard">
            <h4 class="text-white"><img src="<?=base_url()?>gbr/LOGO.png" class="admin_img" alt="logo">Sistem Informasi Pengukuran Beban Gardu Di PLN</h4>
         </a>
