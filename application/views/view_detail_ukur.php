                                                ...
                                                if(!empty($getPengukuran))
                                                {
                                                    ...
                                                    { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                 <?php echo anchor('Admincont/edit_Pengukuran/'.$value->id_pengukuran,'<i class="btn  btn-succes fa fa-edit"> </i>'); ?>
                                                                   <?php echo anchor('Admincont/hapus_data_pengukuran/'.$value->id_pengukuran,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
                                                        </tr>   
                                                <?php   }
                                                }?>
