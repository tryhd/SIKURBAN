                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('Admincont/TambahPenyulang')?>" id="editable_table_new" class=" btn btn-default">
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">No</th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">ID penyualang</th>
                                                    <th class="sorting_asc wid-1" tabindex="0" rowspan="1" colspan="1">Nama penyualang</th>
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Stataus</th>
                                                ...
                                                if(!empty($getPenyulang))
                                                {
													...
													{ ?>
														<tr>
															...
															<td><?=$value->status?></td>
															<td>
                                                                <?php echo anchor('Admincont/edit_penyulang/'.$value->id_penyulang,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                <?php echo anchor('Admincont/hapus_data_penyulang/'.$value->id_penyulang,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
														</tr>	
												<?php	}
                                                }
