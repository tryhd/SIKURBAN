                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('Admincont/export_excel')?>" id="editable_table_new" class=" btn btn-default">
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc wid-1" tabindex="0" rowspan="1" colspan="1">id Gardu</th>
                                                    ...
                                                    { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                 ...
                                                                 <?php echo anchor('Admincont/DetailPengukuran/'.$value->id_pengukuran,'<i class="btn  btn-success">Detail</i>'); ?>
