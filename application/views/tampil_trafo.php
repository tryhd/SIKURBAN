                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('Admincont/TambahTrafo')?>" id="editable_table_new" class=" btn btn-default">
                                        Tambah Trafo <i class="fa fa-plus"></i>
                                    </a>
                                    </div>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">ID Trafo</th>
                                                ...
                                                if(!empty($getTrafo))
                                                {
													...
													{ ?>
														<tr>
                                                            ...
                                                            <td><?=$value->tahun?></td>
															<td>
                                                                <?php echo anchor('Admincont/edit_trafo/'.$value->id_trafo,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                <?php echo anchor('Admincont/hapus_data_trafo/'.$value->id_trafo,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
														</tr>	
												<?php	}
                                                }
