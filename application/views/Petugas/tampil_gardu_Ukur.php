                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Jenis</th>
                                                     <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">JNo Gardu</th>
													...
													{ ?>
														<tr>
															...
															<td>
                                                                 ...
                                                                 <?php echo anchor('petugas/Petugascont/TambahPengukuran/'.$value->id_gardu,'<i class="btn  btn-success">Ukur </i>'); ?>
                                                                 <?php echo anchor('Petugas/Petugascont/RiwayatUkur/'.$value->nama_gardu,'<i class="btn  btn-success">Riwayat</i>'); ?>
