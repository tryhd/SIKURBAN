                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting_asc wid-1" tabindex="0" rowspan="1" colspan="1">Beban Terukur</th>
													...
													{ ?>
														<tr>
                                                            ...
                                                            <td>
                                                                 ...
                                                                 <?php echo anchor('Petugas/Petugascont/DetailPengukuran/'.$value->id_pengukuran,'<i class="btn  btn-success">Detail</i>'); ?>
