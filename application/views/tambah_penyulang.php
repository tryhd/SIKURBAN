                ...
                <div class="main-bar">
                    ...
                    <div class="col-sm-7 col-lg-6">
                        <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                            ...
                            <li class="active breadcrumb-item">Tambah Penyulang</li>
                        </ol>
                    </div>
                    </div>
                </div>
					...
					<?php } ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 input_field_sections">
                                            ...
                                            <input required type="text" class="form-control" name="id_penyulang" value="<?=$kodeasu;?>" readonly/>
                                        </div>
                                         <div class="col-lg-4 input_field_sections">
                                            <h5>Nama Penyulang <span style="color: #cc0000">*</span></h5>
                                            <input required type="text" class="form-control" name="nama_penyulang" value=""/>
                                        </div>
                                        <div class="col-lg-4 input_field_sections">
