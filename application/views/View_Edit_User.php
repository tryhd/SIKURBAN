                ...
                <div class="main-bar">
                    ...
                    <div class="col-sm-7 col-lg-6">
                        <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                            ...
                            <li class="active breadcrumb-item">Edit user</li>
                        </ol>
                    </div>
                    </div>
                </div>
            ...
            <div class="outer">
                <div class="inner bg-container forms">
                    ...
                    <?php } ?>
                                    ...
                                    <form action="<?php echo base_url().'Admincont/update_user'; ?>" method="post">
                                    <div class="row">
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>ID <span style="color: #cc0000">*</span></h5>
                                            <input required type="" class="form-control" name="id" value="<?php echo $value->id ?>"readonly>
                                        </div>
                                        <div class="col-lg-4 input_field_sections">
                                            <h5>Nama<span style="color: #cc0000">*</span></h5>
                                            <input required type="text" class="form-control" name="nama" value="<?php echo $value->nama ?>"/>
                                        </div>
                                        <div class="col-lg-4 input_field_sections">
                                         ...
                                         <div class="col-lg-4 input_field_sections">
                                            ...
                                            <input required  type="username" class="form-control" name="username" value="<?php echo $value->username ?>"/>
                                        </div>
                                      <div class="col-lg-4 input_field_sections">
                                            <h5>Password <span style="color: #cc0000">*</span></h5>
                                            <input required  type="password" class="form-control" name="password" value="<?php echo $value->password ?>"/>
                                        </div>
