                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('index.php/Admincont/TambahGardu')?>" id="editable_table_new" class=" btn btn-default">
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Nama Penyulang</th>
                                                    ...
                                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Jenis</th>
                                                     ...
                                                     <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Wilayah</th>
                                                ...
                                                if(!empty($getGardu))
                                                {
													...
													{ ?>
														<tr>
															...
															<td>
                                                                <?php echo anchor('Admincont/edit_gardu/'.$value->id_gardu,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                <?php echo anchor('Admincont/hapus_data_gardu/'.$value->id_gardu,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
														</tr>	
												<?php	}
                                                }
