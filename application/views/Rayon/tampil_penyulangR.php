                                                ...
                                                if(!empty($getPenyulang))
                                                {
													...
													{ ?>
														<tr>
															...
															<td><?=$value->status?></td>
															<td>
                                                                <?php echo anchor('Rayoncont/edit_penyulang/'.$value->id_penyulang,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                <?php echo anchor('Rayoncont/hapus_data_penyulang/'.$value->id_penyulang,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
														</tr>	
												<?php	}
                                                }
