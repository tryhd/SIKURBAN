                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">Daya</th>
                                                ...
                                                if(!empty($getGardu))
                                                {
                                                    ...
                                                    { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo anchor('Rayon/Rayoncont/edit_gardu/'.$value->id_gardu,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                <?php echo anchor('Rayon/Rayoncont/hapus_data_gardu/'.$value->id_gardu,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
                                                        </tr>   
                                                <?php   }
                                                }
