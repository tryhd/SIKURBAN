                ...
                <div class="inner bg-container forms">
                    ...
                    <?php } ?>
                          <?php foreach($data_gardu as $value){ ?>
                                    <form action="<?php echo base_url(). 'Rayon/Rayoncont/update_gardu'; ?>" method="post">
                                     <div class="row">
                                        ...
                                        <div class="col-lg-4 input_field_sections">
                                         ...
                                         <div class="col-lg-4 input_field_sections">
                                          ...
                                          <div class="col-lg-4 input_field_sections">
                                            ...
                                            <input required  type="text" class="form-control" name="id_rayon" value="<?php echo $value->id_rayon ?>"readonly>
                                        </div>
                                    <div class="col-lg-4 input_field_sections">
