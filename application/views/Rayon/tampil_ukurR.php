                    ...
                    <div class="inner bg-container">
                       ...
                       <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('Rayon/Rayoncont/export_excel')?>" id="editable_table_new" class=" btn btn-default">
                                                    ...
                                                    { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                 ...
                                                                 <?php echo anchor('Rayon/Rayoncont/DetailPengukuran/'.$value->id_pengukuran,'<i class="btn  btn-success">Detail</i>'); ?>
