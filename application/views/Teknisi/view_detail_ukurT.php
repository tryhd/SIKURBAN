                                                ...
                                                if(!empty($getPengukuran))
                                                {
                                                    ...
                                                    { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                 <?php echo anchor('Teknisi/Teknisicont/edit_Pengukuran/'.$value->id_pengukuran,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                 <?php echo anchor('Teknisi/Teknisicont/hapus_data_ukur/'.$value->id_pengukuran,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
