...
<head>
    <meta charset="UTF-8">
    <title>Dashboard Teknisi | SIKURBAN</title>
    <?php
                    ...
                    <div class="col-sm-7 col-lg-6">
                        <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                            <li class="breadcrumb-item">
                                <a href="<?=base_url()?>dashboardTeknisi">
                ...
                <div class="inner bg-container">
                    ...
                    <div class="row widget_countup">
                        <div class="col-12 col-sm-6 col-xl-3">
                            <div id="top_widget1" style="perspective: 490px; position: relative; transform-style: preserve-3d;">
                                <div class="front" style="backface-visibility: hidden; transform-style: preserve-3d; position: absolute; z-index: 1; height: 100%; width: 100%; transition: all 0.5s ease-out 0s; transform: rotateX(0deg);">
                                    <div class="bg-primary p-d-15 b_r_5" style="backface-visibility: hidden;">
                                        ...
                                        <div class="user_font" style="backface-visibility: hidden;">Penyulang</div>
                                        <div id="widget_countup1" style="backface-visibility: hidden;">
                                          <?php
                                           echo count($penyulang);
                                           ?>   
                                        </div>
                                        <div class="tag-white" style="backface-visibility: hidden;">
                                            
                                        </div>
                                        <div class="previous_font" style="backface-visibility: hidden;">Total Penyulang</div>
                                    </div>
                                </div>
                                <div class="back" style="backface-visibility: hidden; transform-style: preserve-3d; position: relative; z-index: 0; height: 100%; width: 100%; transform: rotateX(-180deg); transition: all 0.5s ease-out 0s;">
                                    <div class="bg-white b_r_5 section_border" style="backface-visibility: hidden;">
                                        <div class="p-t-l-r-15" style="backface-visibility: hidden;">
                                            ...
                                            <div id="widget_countup12" style="backface-visibility: hidden;">3,250</div>
                                            <div style="backface-visibility: hidden;">Penyulang</div>
                                        </div>

                                        <div class="row" style="backface-visibility: hidden;">
                                            <div class="col-lg-12" style="backface-visibility: hidden;">
                                                <span id="visitsspark-chart" class="spark_line" style="backface-visibility: hidden;"><canvas style="display: inline-block; width: 242.25px; height: 48px; vertical-align: top; backface-visibility: hidden;" width="242" height="48"></canvas></span>
                                            </div>
                                        </div>
