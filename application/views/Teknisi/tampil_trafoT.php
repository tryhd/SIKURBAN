                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('Teknisi/Teknisicont/TambahTrafo')?>" id="editable_table_new" class=" btn btn-default">
                                                ...
                                                if(!empty($getTrafo))
                                                {
													...
													{ ?>
														<tr>
                                                            ...
                                                            <td><?=$value->tahun?></td>
															<td>
                                                                <?php echo anchor('Teknisi/Teknisicont/edit_trafo/'.$value->id_trafo,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                <?php echo anchor('Teknisi/Teknisicont/hapus_data_trafo/'.$value->id_trafo,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
														</tr>	
												<?php	}
                                                }
