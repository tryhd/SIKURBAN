                    ...
                    <div class="inner bg-container">
                        ...
                        <?php } ?>
                                ...
                                <div class="table-toolbar">
                                    <div class="btn-group">
                                        <a href="<?=base_url('Teknisi/Teknisicont/TambahGardu')?>" id="editable_table_new" class=" btn btn-default">
                                        Tambah gardu <i class="fa fa-plus"></i>
                                    </a>
                                    </div>
                                        ...
                                        <table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting wid-10" tabindex="0" rowspan="1" colspan="1">ID Penyulang</th>
                                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Daya</th>
                                                    <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">ID Jenis</th>
                                                ...
                                                if(!empty($getGardu))
                                                {
													...
													{ ?>
														<tr>
															...
															<td>
                                                                <?php echo anchor('Teknisi/Teknisicont/edit_gardu/'.$value->id_gardu,'<i class="btn  btn-succes fa fa-edit"></i>'); ?>
                                                                <?php echo anchor('Teknisi/Teknisicont/hapus_data_gardu/'.$value->id_gardu,'<i class="btn  btn-blue fa fa-trash-o hapus"> </i>'); ?>
                                                            </td>
														</tr>	
												<?php	}
                                                }
